...
module hlth_chain (
   ...
   // INV_X16_genblk10IX16 \genblk1[0].IX16  (.I(B[1]),
	// .ZN(B[2]));
   INV_X16_genblk10IX16 \genblk1[0].IX16  (.I(I),
	.ZN(B[2]));
   ...
   INV_X16_genblk14IX16 \genblk1[4].IX16  (.I(B[5]),
	.ZN(B[6]));
   INV_X8_genblk27IX8 \genblk2[7].IX8  (.I(B[7]),
	.ZN(B[8]));
   
   // Changed
   // INV_X8_genblk28IX8 \genblk2[8].IX8  (.I(B[8]),
	// .ZN(B[9]));
   INV_X8_genblk28IX8 \genblk2[8].IX8  (.I(B[8]),
	.ZN(Z));

   // Not fitted
   // INV_X8_genblk29IX8 \genblk2[9].IX8  (.I(B[9]),
	// .ZN(Z));
endmodule
